...
using MHUrho.EditorTools.MouseKeyboard.TerrainManipulation;
using MHUrho.Input.MouseKeyboard;
using MHUrho.UserInterface.MouseKeyboard;
using MHUrho.WorldMap;

namespace MHUrho.EditorTools.MouseKeyboard {
	public class TerrainManipulatorTool : MHUrho.EditorTools.Base.TerrainManipulatorTool, IMouseKeyboardTool {
