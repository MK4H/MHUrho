...
/*
 * This file contains classes derived from the XML schema stored at Data/Schemas/GamePack.xsd.
 * These classes enable us to easily work with the XML without repeating string constants everywhere.
 * 
 * Singleton design pattern is used extensively to enable inheritance, to make representation of the
 * inheritance in the XSD easier.
 *
 * In the future this file could be autogenerated with some tool, if we ever find such a tool.
 */
