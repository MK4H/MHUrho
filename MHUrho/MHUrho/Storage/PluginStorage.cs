...
namespace MHUrho.Storage {
  ...
  public sealed partial class Data : pb::IMessage<Data> {
    ...
    public override int GetHashCode() {
      int hash = 1;
      if (contentsCase_ == ContentsOneofCase.Float) hash ^= pbc::ProtobufEqualityComparers.BitwiseSingleEqualityComparer.GetHashCode(Float);
      if (contentsCase_ == ContentsOneofCase.Double) hash ^= pbc::ProtobufEqualityComparers.BitwiseDoubleEqualityComparer.GetHashCode(Double);
